 ...
 */
public class MultiMBTilesFileArchive implements IArchiveFile {
    ...
    private final int mMapIdentifier;
    public MultiMBTilesFileArchive(final SQLiteDatabase pDatabase, final int mapIdentifier) {
        mDatabase = pDatabase;
        mMapIdentifier = mapIdentifier;
    }

    public static MultiMBTilesFileArchive getDatabaseFileArchive(final File pFile, final int mapIdentifier)
            throws SQLiteException {
        return new MultiMBTilesFileArchive(SQLiteDatabase.openDatabase(pFile.getAbsolutePath(), null,
    ...
    private String getStringValue(String key) {
        ...
        final String[] query = { key, Integer.toString(mMapIdentifier) };

        Cursor c =
                this.mDatabase.query(TABLE_METADATA, column, "name = ? and map_id = ?", query, null, null, null);
        try {
            c.moveToFirst();
    ...
    private static final String TAG = "MultiMBTilesFileArchive";
}
